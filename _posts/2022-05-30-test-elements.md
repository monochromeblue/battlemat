          ...
          <form>
            <fieldset id="forms__input">
              ...
              <p>
                ...
                <input id="input__text3" placeholder="Text Input">
              </p>
              <p>
                <label for="input__text4" class="valid">Valid</label>
                <input id="input__text4" placeholder="Text Input">
              </p>
            </fieldset>
